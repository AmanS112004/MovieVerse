    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          style={{
            background: 'linear-gradient(180deg, #0B0F1A 0%, #000000 100%)',
        ...
        >
          {/* Header */}
          <div className="flex items-center justify-between p-6 border-b border-white/5 relative z-20 bg-[#0B0F1A]/80 backdrop-blur-md">
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-xl bg-[#E11D48]/10 border border-[#E11D48]/20">
                <Scale className="w-6 h-6 text-[#E11D48]" />
              </div>
              <div>
                <h2 className="font-black text-xl text-white tracking-tight uppercase">Advanced Confrontation</h2>
                <p className="text-[10px] font-bold text-gray-500 tracking-[0.2em] uppercase mt-0.5">Deep Metadata & AI Sentiment Analysis</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              {compareQueue.length > 0 && (
                <motion.button
                  ...
                  className="px-4 py-2 rounded-xl text-xs font-black text-gray-500 hover:bg-red-500/10 hover:text-red-400 border border-transparent hover:border-red-500/20 transition-all uppercase tracking-widest"
                >
                  Clear Arena
                </motion.button>
              )}
              <motion.button 
                ...
                whileTap={{ scale: 0.9 }} 
                onClick={onClose}
                className="p-2.5 rounded-full bg-white/5 border border-white/10 hover:bg-white/15 transition-all"
              >
          ...
          {!m1 || !m2 ? (
            <div className="flex-1 flex flex-col items-center justify-center p-10 text-center">
              <div className="relative mb-8">
                <Scale className="w-24 h-24 text-white/5" />
                <div className="absolute inset-0 flex items-center justify-center">
                  <Zap className="w-10 h-10 text-[#E11D48] animate-pulse" />
                </div>
              </div>
              <h3 className="text-2xl font-black text-white mb-3 uppercase tracking-tight">The Arena is Empty</h3>
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-10 text-center">
              ...
              <h3 className="text-xl font-black text-white mb-2 uppercase">Confrontation Interrupted</h3>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => refetch()}
                className="px-8 py-3 rounded-2xl bg-[#E11D48] text-white font-bold text-sm shadow-xl transition-all hover:opacity-90"
              >
                Rebuild Arena
              </motion.button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-[#E11D48]/5 to-transparent pointer-events-none" />
                 ...
                 <div className="relative z-10 grid grid-cols-[1fr_auto_1fr] gap-4 sm:gap-20 items-center">
                        ...
                        <div className="relative mb-6">
                            {win && (
                              <motion.div 
                                ...
                                className="absolute -top-6 -right-6 z-30 bg-[#E11D48] text-white px-4 py-2 rounded-2xl font-black text-xs shadow-[0_0_40px_rgba(225,29,72,0.6)] flex items-center gap-2 uppercase"
                              >
                            ...
                            <div className={cn(
                              ...
                              win ? "border-[#E11D48] shadow-[0_0_80px_rgba(225,29,72,0.2)] scale-105" : "border-white/10 opacity-60 grayscale-[0.5]"
                            )}>
                              ...
                              <div className="absolute inset-x-0 bottom-0 p-4 bg-gradient-to-t from-black/90 to-transparent">
                                 ...
                                 <div className="text-[10px] uppercase font-black text-white opacity-80 tracking-widest">Match Score</div>
                              </div>
                            </div>
                        </div>
                        <h3 className="text-xl sm:text-2xl font-black text-white leading-tight max-w-xs">{film.title}</h3>
                        <p className="text-xs font-bold text-gray-500 mt-2 uppercase tracking-[0.3em]">{formatDate(film.release_date)}</p>
                      </motion.div>
                    );
                  })}
                  ...
                  <div className="flex flex-col items-center justify-center relative h-full">
                    <div className="w-16 h-16 rounded-full border-2 border-[#E11D48]/20 flex items-center justify-center bg-black/40 backdrop-blur-xl relative z-10 overflow-hidden shadow-2xl">
                      <motion.div 
                        animate={{ scale: [1, 1.2, 1] }} 
                        transition={{ duration: 2, repeat: Infinity }}
                        className="text-2xl font-black text-[#E11D48]"
                      >
                        VS
                      </motion.div>
                    </div>
                    <div className="absolute top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-[#E11D48]/20 to-transparent" />
                  </div>
              ...
              <div className="px-6 mb-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Watch If A */}
                  <div className="p-6 rounded-[32px] border border-[#E11D48]/10 bg-white/[0.02] relative group overflow-hidden">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                       ...
                       <h4 className="text-sm font-black text-white uppercase tracking-widest">Watch "{result.movie1.title}" if...</h4>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-2 mt-4">
                       {result.insights?.pros_a?.slice(0,3).map(p => (
                         <span key={p} className="text-[10px] font-black uppercase tracking-tighter px-2 py-1 rounded bg-[#E11D48]/5 text-[#E11D48]/60">+{p}</span>
                       ))}
                    </div>
                  </div>
                  ...
                  <div className="p-6 rounded-[32px] border border-[#E11D48]/10 bg-white/[0.02] relative group overflow-hidden">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                       ...
                       <h4 className="text-sm font-black text-white uppercase tracking-widest">Watch "{result.movie2.title}" if...</h4>
                    </div>
                    <p className="text-sm text-gray-300 leading-relaxed font-medium">
                    ...
                    <table className="w-full text-left border-collapse min-w-[500px]">
                        <thead>
                            <tr className="border-b border-white/[0.05]">
                                <th className="p-6 text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] w-1/3">Metric Analysis</th>
                                <th className="p-6 text-sm font-black text-white text-center w-1/3 truncate">{result.movie1.title}</th>
                                <th className="p-6 text-sm font-black text-white text-center w-1/3 truncate">{result.movie2.title}</th>
                            </tr>
                        </thead>
                        <tbody className="text-sm">
                            {[
                                ...
                                <tr key={i} className="group hover:bg-[#E11D48]/5 transition-colors border-b border-white/[0.02]">
                                    <td className="p-5 flex items-center gap-3">
                                        <span className="text-gray-500 transition-colors group-hover:text-[#E11D48]">
                                          <row.icon size={16} />
                                        </span>
                                        <span className="font-bold text-gray-400">{row.label}</span>
                                    </td>
                                    <td className={cn("p-5 text-center font-black", row.w === 1 ? "text-[#E11D48]" : "text-gray-700")}>
                                        {row.v1} {row.w === 1 && '⭐'}
                                    </td>
                                    <td className={cn("p-5 text-center font-black", row.w === 2 ? "text-[#E11D48]" : "text-gray-700")}>
                                        {row.w === 2 && '⭐'} {row.v2}
                                    </td>
                                </tr>
                            ))}
              ...
              <div className="px-6 mb-16 grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-10 items-center">
                  <div className="flex flex-col items-center">
                    <VibeChart vibe={result.movie1.vibe as any} size={280} color="#E11D48" />
                    <p className="text-[10px] font-black text-white uppercase tracking-[0.2em] mt-6">Atmospheric Sig: A</p>
                  </div>
                  
                  <div className="hidden lg:flex flex-col items-center gap-4">
                     {['Action', 'Comedy', 'Dark', 'Story', 'Pacing'].map(v => (
                       <div key={v} className="px-4 py-2 rounded-xl bg-white/[0.03] border border-white/5 text-[10px] font-black text-gray-500 uppercase">
                         {v}
                       </div>
                     ))}
                  </div>
                  ...
                  <div className="flex flex-col items-center">
                    <VibeChart vibe={result.movie2.vibe as any} size={280} color="#2563EB" />
                    <p className="text-[10px] font-black text-white uppercase tracking-[0.2em] mt-6">Atmospheric Sig: B</p>
                  </div>
              </div>
              ...
              <div className="px-6 pb-20 space-y-12">
                 ...
                 {result.sharedCast.length > 0 && (
                   <div>
                      <div className="flex items-center gap-2 mb-6">
                        ...
                        <h4 className="text-sm font-black text-gray-500 uppercase tracking-[0.2em]">Crossover Talent Detected</h4>
                      </div>
                      <div className="flex flex-wrap gap-4">
                        {result.sharedCast.map(actor => (
                          <div key={actor.id} className="flex items-center gap-3 p-3 rounded-2xl bg-white/[0.03] border border-white/5">
                             <div className="w-10 h-10 rounded-full overflow-hidden border border-[#E11D48]/20">
                                <img src={getPosterUrl(actor.profile_path, 'w185')} alt={actor.name} className="w-full h-full object-cover" />
                             </div>
                             <div>
                                <p className="text-xs font-black text-white uppercase tracking-tighter">{actor.name}</p>
                                <p className="text-[10px] text-gray-500 font-bold">Appears in Both</p>
                             </div>
                          </div>
                        ))}
                      </div>
                 ...
                 <div className="pt-10 border-t border-white/5">
                    <button 
                      ...
                      className="flex items-center gap-2 text-[10px] font-black text-gray-600 hover:text-[#E11D48] transition-colors uppercase tracking-[0.2em]"
                    >
                    ...
                    <AnimatePresence>
                      {showScoring && (
                        ...
                        >
                          <div className="p-6 rounded-[32px] bg-[#E11D48]/5 text-xs text-gray-400 font-medium leading-relaxed max-w-3xl">
                             Our algorithm uses a weighted system to provide a definitive recommendation:
                             <ul className="mt-4 space-y-2">
                                <li>• <span className="font-bold text-white">25% Critical Rating:</span> Sourced from TMDB & IMDb community consensus.</li>
                                <li>• <span className="font-bold text-white">20% Popularity & Buzz:</span> Real-time trending data and global search volume.</li>
                                <li>• <span className="font-bold text-white">20% Atmospheric Match:</span> Thematic alignment between genres, keywords, and mood.</li>
                                <li>• <span className="font-bold text-white">15% Award Recognition:</span> Star power and critical accolades (Oscars, major wins).</li>
                                <li>• <span className="font-bold text-white">20% Audience Sentiment:</span> AI-driven analysis of user reviews and common pros/cons.</li>
                             </ul>
...
function ReviewSummary({ id, title, mediaType }: { id: number; title: string; mediaType: string }) {
  ...
  return (
    <div className="space-y-2">
      <p className="text-[10px] font-black text-white uppercase tracking-[0.1em]">{title}</p>
      {isLoading ? (
        <div className="space-y-2">
